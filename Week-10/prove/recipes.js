...
const recipes = [
    ...
    {
        author: "Jacob Derington",
        url: "",
        isBasedOn: "",
        cookTime: "10 min",
        datePublished: "2026-03-14",
        tags: ["ramen", "quick", "chicken", "spicy"],
        description: "A quick spicy ramen stir fry topped with a crispy chicken patty and fresh lettuce.",
        image: "./images/chicken-patty-ramen.jpg",
        recipeIngredient: [
            "1 package Shin Ramen",
            "1 frozen chicken patty",
            "1 handful lettuce",
            "1 Shin ramen soup base packet",
            "1 Shin ramen vegetable flakes packet",
            "Water (enough to cover noodles)"
        ],
        name: "Shin Ramen Stir Fry with Crispy Chicken Patty",
        prepTime: "5 min",
        recipeInstructions: [
            "Place the frozen chicken patty on a microwave-safe plate and microwave for about 1–2 minutes to defrost it.",
            "Transfer the defrosted patty to the air fryer and cook at 375°F for about 4–6 minutes until the outside becomes crispy.",
            "While the chicken crisps, place the ramen noodles and the vegetable flakes packet in a microwave-safe bowl.",
            "Add just enough water to cover the noodles.",
            "Microwave the noodles for 3–4 minutes until soft.",
            "Carefully drain most of the water, leaving about 1–2 tablespoons so the noodles stay slightly saucy.",
            "Add about 1/2 to 3/4 of the Shin Ramen soup base packet and mix well so the noodles are coated.",
            "Tear the lettuce into strips and mix it into the hot noodles.",
            "Microwave the bowl again for 20–30 seconds to slightly soften the lettuce.",
            "Slice the crispy chicken patty into strips and place it on top of the ramen.",
            "Let the noodles sit for about 1 minute so the sauce thickens and coats the noodles before serving."
        ],
...
function search() {
    ...
    let recipeQuery = input.value.toLowerCase();
    ...
    let filteredRecipes = recipes.filter(function(recipe){
        return (
            ...
            recipe.tags.find(tag => tag.toLowerCase().includes(recipeQuery))
        );
    });
